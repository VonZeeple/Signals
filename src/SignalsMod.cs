...
namespace signals.src
{
    public class SignalsMod : ModSystem
    {
        ...
        public override void Start(ICoreAPI api)
        {
            ...
            api.RegisterBlockBehaviorClass("BlockBehaviorSparseMultiblock", typeof(BlockBehaviorSparseMultiblock));
            ...
            api.RegisterBlockEntityBehaviorClass("BEBehaviorSignalTetrode", typeof(BEBehaviorSignalTetrode));
